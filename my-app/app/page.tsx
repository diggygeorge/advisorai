          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            <div className="flex gap-4">
              <select
                ...
                className="flex-1 px-2 py-2 border text-black-b border-gray-300 bg-white text-sm focus:outline-none focus:border-slate-700"
              >
            ...
            <input
              ...
              className="px-2 py-2 border text-black-b border-gray-300 bg-white text-sm focus:outline-none focus:border-slate-700"
            />
